...
const PROFILETAB ProfileTab[] =
{
  ...
  CH0_PAN_USEADDR,16,2,48,CH0_PAN_USEADDR,CH0_PAN_USEADDR,CH0_PAN_CURADDR,
  CH0_PBN_USEADDR,18,2,48,CH0_PBN_USEADDR,CH0_PBN_USEADDR,CH0_PBN_CURADDR,
  CH0_PCN_USEADDR,20,2,48,CH0_PCN_USEADDR,CH0_PCN_USEADDR,CH0_PCN_CURADDR,
  CH0_PTD_USEADDR,22,2,48,CH0_PTD_USEADDR,CH0_PTD_USEADDR,CH0_PTD_CURADDR,
  CH0_CLR_USEADDR,24,2,48,CH0_CLR_USEADDR,CH0_CLR_USEADDR,CH0_CLR_CURADDR,
  
  LOAD1_USEADDR,26,3,ONE_RECORD_SIZE,LOAD1_USEADDR,LOAD1_USEADDR,LOAD1_CURADDR,
  RAND1_USEADDR,29,2,ONE_RECORD_SIZE,RAND1_USEADDR,RAND1_USEADDR,RAND1_CURADDR,
  FRZD1_USEADDR,31,2,ONE_RECORD_SIZE,FRZD1_USEADDR,FRZD1_USEADDR,FRZD1_CURADDR,
  SHRP1_USEADDR,33,7,ONE_RECORD_SIZE,SHRP1_USEADDR,SHRP1_USEADDR,SHRP1_CURADDR,
  MOND1_USEADDR,40,2,ONE_RECORD_SIZE,MOND1_USEADDR,MOND1_USEADDR,MOND1_CURADDR,
  CH1_PAP_USEADDR,42,2,48,CH1_PAP_USEADDR,CH1_PAP_USEADDR,CH1_PAP_CURADDR,
  CH1_PBP_USEADDR,44,2,48,CH1_PBP_USEADDR,CH1_PBP_USEADDR,CH1_PBP_CURADDR,
  CH1_PCP_USEADDR,46,2,48,CH1_PCP_USEADDR,CH1_PCP_USEADDR,CH1_PCP_CURADDR,
  CH1_PAN_USEADDR,48,2,48,CH1_PAN_USEADDR,CH1_PAN_USEADDR,CH1_PAN_CURADDR,
  CH1_PBN_USEADDR,50,2,48,CH1_PBN_USEADDR,CH1_PBN_USEADDR,CH1_PBN_CURADDR,
  CH1_PCN_USEADDR,52,2,48,CH1_PCN_USEADDR,CH1_PCN_USEADDR,CH1_PCN_CURADDR,
  CH1_PTD_USEADDR,54,2,48,CH1_PTD_USEADDR,CH1_PTD_USEADDR,CH1_PTD_CURADDR,
  CH1_CLR_USEADDR,56,2,48,CH1_CLR_USEADDR,CH1_CLR_USEADDR,CH1_CLR_CURADDR,
  
  LOAD2_USEADDR,58,3,ONE_RECORD_SIZE,LOAD2_USEADDR,LOAD2_USEADDR,LOAD2_CURADDR,
  RAND2_USEADDR,60,2,ONE_RECORD_SIZE,RAND2_USEADDR,RAND2_USEADDR,RAND2_CURADDR,
  FRZD2_USEADDR,62,2,ONE_RECORD_SIZE,FRZD2_USEADDR,FRZD2_USEADDR,FRZD2_CURADDR,
  SHRP2_USEADDR,64,7,ONE_RECORD_SIZE,SHRP2_USEADDR,SHRP2_USEADDR,SHRP2_CURADDR,
  MOND2_USEADDR,71,2,ONE_RECORD_SIZE,MOND2_USEADDR,MOND2_USEADDR,MOND2_CURADDR,
  CH2_PAP_USEADDR,73,2,48,CH2_PAP_USEADDR,CH2_PAP_USEADDR,CH2_PAP_CURADDR,
  CH2_PBP_USEADDR,75,2,48,CH2_PBP_USEADDR,CH2_PBP_USEADDR,CH2_PBP_CURADDR,
  CH2_PCP_USEADDR,77,2,48,CH2_PCP_USEADDR,CH2_PCP_USEADDR,CH2_PCP_CURADDR,
  CH2_PAN_USEADDR,79,2,48,CH2_PAN_USEADDR,CH2_PAN_USEADDR,CH2_PAN_CURADDR,
  CH2_PBN_USEADDR,81,2,48,CH2_PBN_USEADDR,CH2_PBN_USEADDR,CH2_PBN_CURADDR,
  CH2_PCN_USEADDR,83,2,48,CH2_PCN_USEADDR,CH2_PCN_USEADDR,CH2_PCN_CURADDR,
  CH2_PTD_USEADDR,85,2,48,CH2_PTD_USEADDR,CH2_PTD_USEADDR,CH2_PTD_CURADDR,
  CH2_CLR_USEADDR,87,2,48,CH2_CLR_USEADDR,CH2_CLR_USEADDR,CH2_CLR_CURADDR,
  
  LOAD3_USEADDR,89,3,ONE_RECORD_SIZE,LOAD3_USEADDR,LOAD3_USEADDR,LOAD3_CURADDR,
  RAND3_USEADDR,92,2,ONE_RECORD_SIZE,RAND3_USEADDR,RAND3_USEADDR,RAND3_CURADDR,
  FRZD3_USEADDR,94,2,ONE_RECORD_SIZE,FRZD3_USEADDR,FRZD3_USEADDR,FRZD3_CURADDR,
  SHRP3_USEADDR,96,7,ONE_RECORD_SIZE,SHRP3_USEADDR,SHRP3_USEADDR,SHRP3_CURADDR,
  MOND3_USEADDR,103,2,ONE_RECORD_SIZE,MOND3_USEADDR,MOND3_USEADDR,MOND3_CURADDR,
  CH3_PAP_USEADDR,105,2,48,CH3_PAP_USEADDR,CH3_PAP_USEADDR,CH3_PAP_CURADDR,
  CH3_PBP_USEADDR,107,2,48,CH3_PBP_USEADDR,CH3_PBP_USEADDR,CH3_PBP_CURADDR,
  CH3_PCP_USEADDR,109,2,48,CH3_PCP_USEADDR,CH3_PCP_USEADDR,CH3_PCP_CURADDR,
  CH3_PAN_USEADDR,111,2,48,CH3_PAN_USEADDR,CH3_PAN_USEADDR,CH3_PAN_CURADDR,
  CH3_PBN_USEADDR,113,2,48,CH3_PBN_USEADDR,CH3_PBN_USEADDR,CH3_PBN_CURADDR,
  CH3_PCN_USEADDR,115,2,48,CH3_PCN_USEADDR,CH3_PCN_USEADDR,CH3_PCN_CURADDR,
  CH3_PTD_USEADDR,117,2,48,CH3_PTD_USEADDR,CH3_PTD_USEADDR,CH3_PTD_CURADDR,
  CH3_CLR_USEADDR,119,2,48,CH3_CLR_USEADDR,CH3_CLR_USEADDR,CH3_CLR_CURADDR,
  
  LOAD4_USEADDR,121,3,ONE_RECORD_SIZE,LOAD4_USEADDR,LOAD4_USEADDR,LOAD4_CURADDR,
  RAND4_USEADDR,124,2,ONE_RECORD_SIZE,RAND4_USEADDR,RAND4_USEADDR,RAND4_CURADDR,
  FRZD4_USEADDR,126,2,ONE_RECORD_SIZE,FRZD4_USEADDR,FRZD4_USEADDR,FRZD4_CURADDR,
  SHRP4_USEADDR,128,7,ONE_RECORD_SIZE,SHRP4_USEADDR,SHRP4_USEADDR,SHRP4_CURADDR,
  MOND4_USEADDR,135,2,ONE_RECORD_SIZE,MOND4_USEADDR,MOND4_USEADDR,MOND4_CURADDR,
  CH4_PAP_USEADDR,137,2,48,CH4_PAP_USEADDR,CH4_PAP_USEADDR,CH4_PAP_CURADDR,
  CH4_PBP_USEADDR,139,2,48,CH4_PBP_USEADDR,CH4_PBP_USEADDR,CH4_PBP_CURADDR,
  CH4_PCP_USEADDR,141,2,48,CH4_PCP_USEADDR,CH4_PCP_USEADDR,CH4_PCP_CURADDR,
  CH4_PAN_USEADDR,143,2,48,CH4_PAN_USEADDR,CH4_PAN_USEADDR,CH4_PAN_CURADDR,
  CH4_PBN_USEADDR,145,2,48,CH4_PBN_USEADDR,CH4_PBN_USEADDR,CH4_PBN_CURADDR,
  CH4_PCN_USEADDR,147,2,48,CH4_PCN_USEADDR,CH4_PCN_USEADDR,CH4_PCN_CURADDR,
  CH4_PTD_USEADDR,149,2,48,CH4_PTD_USEADDR,CH4_PTD_USEADDR,CH4_PTD_CURADDR,
  CH4_CLR_USEADDR,151,2,48,CH4_CLR_USEADDR,CH4_CLR_USEADDR,CH4_CLR_CURADDR,
  
  LOAD5_USEADDR,153,3,ONE_RECORD_SIZE,LOAD5_USEADDR,LOAD5_USEADDR,LOAD5_CURADDR,
  RAND5_USEADDR,156,2,ONE_RECORD_SIZE,RAND5_USEADDR,RAND5_USEADDR,RAND5_CURADDR,
  FRZD5_USEADDR,158,2,ONE_RECORD_SIZE,FRZD5_USEADDR,FRZD5_USEADDR,FRZD5_CURADDR,
  SHRP5_USEADDR,160,7,ONE_RECORD_SIZE,SHRP5_USEADDR,SHRP5_USEADDR,SHRP5_CURADDR,
  MOND5_USEADDR,167,2,ONE_RECORD_SIZE,MOND5_USEADDR,MOND5_USEADDR,MOND5_CURADDR,
  CH5_PAP_USEADDR,169,2,48,CH5_PAP_USEADDR,CH5_PAP_USEADDR,CH5_PAP_CURADDR,
  CH5_PBP_USEADDR,171,2,48,CH5_PBP_USEADDR,CH5_PBP_USEADDR,CH5_PBP_CURADDR,
  CH5_PCP_USEADDR,173,2,48,CH5_PCP_USEADDR,CH5_PCP_USEADDR,CH5_PCP_CURADDR,
  CH5_PAN_USEADDR,175,2,48,CH5_PAN_USEADDR,CH5_PAN_USEADDR,CH5_PAN_CURADDR,
  CH5_PBN_USEADDR,177,2,48,CH5_PBN_USEADDR,CH5_PBN_USEADDR,CH5_PBN_CURADDR,
  CH5_PCN_USEADDR,179,2,48,CH5_PCN_USEADDR,CH5_PCN_USEADDR,CH5_PCN_CURADDR,
  CH5_PTD_USEADDR,181,2,48,CH5_PTD_USEADDR,CH5_PTD_USEADDR,CH5_PTD_CURADDR,
  CH5_CLR_USEADDR,183,2,48,CH5_CLR_USEADDR,CH5_CLR_USEADDR,CH5_CLR_CURADDR,
  
  LOAD6_USEADDR,185,3,ONE_RECORD_SIZE,LOAD6_USEADDR,LOAD6_USEADDR,LOAD6_CURADDR,
  RAND6_USEADDR,188,2,ONE_RECORD_SIZE,RAND6_USEADDR,RAND6_USEADDR,RAND6_CURADDR,
  FRZD6_USEADDR,190,2,ONE_RECORD_SIZE,FRZD6_USEADDR,FRZD6_USEADDR,FRZD6_CURADDR,
  SHRP6_USEADDR,192,7,ONE_RECORD_SIZE,SHRP6_USEADDR,SHRP6_USEADDR,SHRP6_CURADDR,
  MOND6_USEADDR,199,2,ONE_RECORD_SIZE,MOND6_USEADDR,MOND6_USEADDR,MOND6_CURADDR,
  CH6_PAP_USEADDR,201,2,48,CH6_PAP_USEADDR,CH6_PAP_USEADDR,CH6_PAP_CURADDR,
  CH6_PBP_USEADDR,203,2,48,CH6_PBP_USEADDR,CH6_PBP_USEADDR,CH6_PBP_CURADDR,
  CH6_PCP_USEADDR,205,2,48,CH6_PCP_USEADDR,CH6_PCP_USEADDR,CH6_PCP_CURADDR,
  CH6_PAN_USEADDR,207,2,48,CH6_PAN_USEADDR,CH6_PAN_USEADDR,CH6_PAN_CURADDR,
  CH6_PBN_USEADDR,209,2,48,CH6_PBN_USEADDR,CH6_PBN_USEADDR,CH6_PBN_CURADDR,
  CH6_PCN_USEADDR,211,2,48,CH6_PCN_USEADDR,CH6_PCN_USEADDR,CH6_PCN_CURADDR,
  CH6_PTD_USEADDR,213,2,48,CH6_PTD_USEADDR,CH6_PTD_USEADDR,CH6_PTD_CURADDR,
  CH6_CLR_USEADDR,215,2,48,CH6_CLR_USEADDR,CH6_CLR_USEADDR,CH6_CLR_CURADDR,
  
  LOAD7_USEADDR,217,3,ONE_RECORD_SIZE,LOAD7_USEADDR,LOAD7_USEADDR,LOAD7_CURADDR,
  RAND7_USEADDR,219,2,ONE_RECORD_SIZE,RAND7_USEADDR,RAND7_USEADDR,RAND7_CURADDR,
  FRZD7_USEADDR,221,2,ONE_RECORD_SIZE,FRZD7_USEADDR,FRZD7_USEADDR,FRZD7_CURADDR,
  SHRP7_USEADDR,223,7,ONE_RECORD_SIZE,SHRP7_USEADDR,SHRP7_USEADDR,SHRP7_CURADDR,
  MOND7_USEADDR,230,2,ONE_RECORD_SIZE,MOND7_USEADDR,MOND7_USEADDR,MOND7_CURADDR,
  CH7_PAP_USEADDR,232,2,48,CH7_PAP_USEADDR,CH7_PAP_USEADDR,CH7_PAP_CURADDR,
  CH7_PBP_USEADDR,234,2,48,CH7_PBP_USEADDR,CH7_PBP_USEADDR,CH7_PBP_CURADDR,
  CH7_PCP_USEADDR,236,2,48,CH7_PCP_USEADDR,CH7_PCP_USEADDR,CH7_PCP_CURADDR,
  CH7_PAN_USEADDR,238,2,48,CH7_PAN_USEADDR,CH7_PAN_USEADDR,CH7_PAN_CURADDR,
  CH7_PBN_USEADDR,240,2,48,CH7_PBN_USEADDR,CH7_PBN_USEADDR,CH7_PBN_CURADDR,
  CH7_PCN_USEADDR,242,2,48,CH7_PCN_USEADDR,CH7_PCN_USEADDR,CH7_PCN_CURADDR,
  CH7_PTD_USEADDR,244,2,48,CH7_PTD_USEADDR,CH7_PTD_USEADDR,CH7_PTD_CURADDR,
  CH7_CLR_USEADDR,246,2,48,CH7_CLR_USEADDR,CH7_CLR_USEADDR,CH7_CLR_CURADDR,
};
